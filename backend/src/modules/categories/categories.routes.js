import { createCategory, getCategories, getCategoryById, updateCategory, deleteCategory } from "./categories.controllers.js";
...
export default function categoryRoutes(app, prefix) {
  ...
  app.route("DELETE", `${prefix}/categories/:id`, authenticateEmployee, authorize("Admin"), deleteCategory);
}
