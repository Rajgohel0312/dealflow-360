import { createProduct, getProducts, getProductById, updateProduct, deleteProduct } from "./products.controllers.js";
...
export default function productRoutes(app, prefix) {
  ...
  app.route("DELETE", `${prefix}/products/:id`, authenticateEmployee, authorize("Admin"), deleteProduct);
}
